...
<head>
    ...
    <!-- Custom Style & Chatbot (TIẾNG VIỆT) -->
    <link rel="stylesheet" href="{{ asset('css/giaodien.css') }}">
    <link rel="stylesheet" href="{{ asset('css/trolyao.css') }}">
    @stack('styles')
</head>
...
<body>
    ...
    <!-- JS BOOTSTRAP, MAIN JS & CHATBOT (TIẾNG VIỆT) -->
    <script src="https://cdn.jsdelivr.net/npm/bootstrap@5.3.2/dist/js/bootstrap.bundle.min.js"></script>
    <script src="{{ asset('js/trangchu.js') }}"></script>
    <script src="{{ asset('js/trolyao.js') }}"></script>
    @stack('scripts')
</body>
